...
#include ".\CSOpSquareRoot.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpSquareRoot::CSOpSquareRoot(): CSOpBase()
	{
		m_intNumInputs = 1;
	};
	//!Default Destructor
	CSOpSquareRoot::~CSOpSquareRoot(){};

	//!Perform the operation on the stack
	int CSOpSquareRoot::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: sqrt(input)
