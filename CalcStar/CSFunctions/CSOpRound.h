...
#ifndef CSTAR_OP_Round_H
#define CSTAR_OP_Round_H
...
namespace CSTAR
{
	...
	class CSOpRound: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpRound();
	...
	static bool blnCSOpRound_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpRound>("round");
    static bool blnCSOpRound2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpRound>("CSOpRound");
}//end namespace
#endif //CSTAR_OP_Round_H