...
#include ".\CSOpBoolNotEqual.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpBoolNotEqual::CSOpBoolNotEqual(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpBoolNotEqual::~CSOpBoolNotEqual(){};

	//!Perform the operation on the stack
	int CSOpBoolNotEqual::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one not equal to the other (A!=B)
