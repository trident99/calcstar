...
#include ".\CSOpBoolOr.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpBoolOr::CSOpBoolOr(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpBoolOr::~CSOpBoolOr(){};

	//!Perform the operation on the stack
	int CSOpBoolOr::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: logical or (A OR B)
