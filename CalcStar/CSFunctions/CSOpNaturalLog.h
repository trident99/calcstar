...
#ifndef CSTAR_OP_NaturalLog_H
#define CSTAR_OP_NaturalLog_H
...
namespace CSTAR
{
	...
	class CSOpNaturalLog: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpNaturalLog();
	...
	static bool blnCSOpNaturalLog_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpNaturalLog>("ln");
    static bool blnCSOpNaturalLog2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpNaturalLog>("CSOpNaturalLog");
}//end namespace
#endif //CSTAR_OP_NaturalLog_H