...
#ifndef CSTAR_OP_SquareRoot_H
#define CSTAR_OP_SquareRoot_H
...
namespace CSTAR
{
	...
	class CSOpSquareRoot: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpSquareRoot();
	...
	static bool blnCSOpSquareRoot_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSquareRoot>("sqrt");
    static bool blnCSOpSquareRoot3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSquareRoot>("CSOpSquareRoot");
}//end namespace
#endif //CSTAR_OP_SquareRoot_H