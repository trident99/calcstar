...
#include ".\CSOpGreaterThan.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpGreaterThan::CSOpGreaterThan(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpGreaterThan::~CSOpGreaterThan(){};

	//!Perform the operation on the stack
	int CSOpGreaterThan::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one greater than the other (A>B)
