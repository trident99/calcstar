...
#include ".\CSOpSubtract.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpSubtract::CSOpSubtract(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpSubtract::~CSOpSubtract(){};

	//!Perform the operation on the stack
	int CSOpSubtract::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: subtract two numbers together (A-B)
