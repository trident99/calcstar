...
#include ".\CSOpDivide.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpDivide::CSOpDivide(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpDivide::~CSOpDivide(){};

	//!Perform the operation on the stack
	int CSOpDivide::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: divide two numbers together (A/B)
