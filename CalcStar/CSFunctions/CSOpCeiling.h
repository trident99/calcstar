...
#ifndef CSTAR_OP_Ceiling_H
#define CSTAR_OP_Ceiling_H
...
namespace CSTAR
{
	...
	class CSOpCeiling: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpCeiling();
	...
	static bool blnCSOpCeiling_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpCeiling>("ceil");
    static bool blnCSOpCeiling3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpCeiling>("CSOpCeiling");
}//end namespace
#endif //CSTAR_OP_Ceiling_H