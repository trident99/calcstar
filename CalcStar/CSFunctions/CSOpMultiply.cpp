...
#include ".\CSOpMultiply.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpMultiply::CSOpMultiply(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpMultiply::~CSOpMultiply(){};

	//!Perform the operation on the stack
	int CSOpMultiply::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: multiply two numbers together (A*B)
