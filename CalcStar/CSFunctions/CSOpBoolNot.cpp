...
namespace CSTAR
{
	...
	//!Default Constructor
	CSOpBoolNot::CSOpBoolNot(): CSOpBase()
	{
		m_intNumInputs = 1;
	};
	//!Default Destructor
	CSOpBoolNot::~CSOpBoolNot(){};

	//!Perform the operation on the stack
	int CSOpBoolNot::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: change to negative value (!B)
