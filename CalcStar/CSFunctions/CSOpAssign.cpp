...
#include ".\CSOpAssign.h"

namespace CSTAR
{
	//Default Constructor
	CSOpAssign::CSOpAssign(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpAssign::~CSOpAssign(){};

	//!Perform the operation on the stack
	int CSOpAssign::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
