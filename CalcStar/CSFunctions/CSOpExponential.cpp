...
#include ".\CSOpExponential.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpExponential::CSOpExponential(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpExponential::~CSOpExponential(){};

	//!Perform the operation on the stack
	int CSOpExponential::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: exp(input)
