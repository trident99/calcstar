...
#ifndef CSTAR_OP_Truncate_H
#define CSTAR_OP_Truncate_H
...
namespace CSTAR
{
	...
	class CSOpTruncate: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpTruncate();
	...
	static bool blnCSOpTruncate_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpTruncate>("trunc");
    static bool blnCSOpTruncate2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpTruncate>("CSOpTruncate");
}//end namespace
#endif //CSTAR_OP_Truncate_H