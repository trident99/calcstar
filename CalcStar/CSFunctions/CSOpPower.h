...
#ifndef CSTAR_OP_Power_H
#define CSTAR_OP_Power_H
...
namespace CSTAR
{
	...
	static bool blnCSOpPower_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpPower>("pow");
    static bool blnCSOpPower2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpPower>("CSOpPower");
}//end namespace
#endif //CSTAR_OP_Power_H