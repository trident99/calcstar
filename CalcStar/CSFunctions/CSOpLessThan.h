...
#ifndef CSTAR_OP_LessThan_H
#define CSTAR_OP_LessThan_H
...
namespace CSTAR
{
	...
	class CSOpLessThan: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpLessThan();
	...
	static bool blnCSOpLessThan_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThan>("<");
	static bool blnCSOpLessThan2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThan>("LT");
	static bool blnCSOpLessThan3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThan>("CSOpLessThan");
}//end namespace
#endif