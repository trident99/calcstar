...
#include ".\CSOpNaturalLog.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpNaturalLog::CSOpNaturalLog(): CSOpBase()
	{
		m_intNumInputs = 1;
	};
	//!Default Destructor
	CSOpNaturalLog::~CSOpNaturalLog(){};

	//!Perform the operation on the stack
	int CSOpNaturalLog::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
