...
#ifndef CSTAR_OP_BoolNot_H
#define CSTAR_OP_BoolNot_H
...
namespace CSTAR
{
	...
	class CSOpBoolNot: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpBoolNot();
	...
	static bool blnCSOpBoolNot_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpBoolNot>("!");
	static bool blnCSOpBoolNot2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpBoolNot>("NOT");
	static bool blnCSOpBoolNot3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpBoolNot>("CSOpBoolNot");
}//end namespace
#endif