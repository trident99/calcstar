...
namespace CSTAR
{
	...
	int CSOpFloor::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		...
		try{
			...
			if(blnValid)
			{
				...
				dblOutput = CMATH::floor(dblInput1);
