...
#include ".\CSOpBoolEqual.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpBoolEqual::CSOpBoolEqual(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpBoolEqual::~CSOpBoolEqual(){};

	//!Perform the operation on the stack
	int CSOpBoolEqual::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one equal to the other (A==B)
