...
#include ".\CSOpGreaterThanEqual.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpGreaterThanEqual::CSOpGreaterThanEqual(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpGreaterThanEqual::~CSOpGreaterThanEqual(){};

	//!Perform the operation on the stack
	int CSOpGreaterThanEqual::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one greater than or equal to the other (A>=B)
