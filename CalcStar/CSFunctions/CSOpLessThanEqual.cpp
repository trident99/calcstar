...
#include ".\CSOpLessThanEqual.h"

namespace CSTAR
{
	//!Default Constructor
	CSOpLessThanEqual::CSOpLessThanEqual(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpLessThanEqual::~CSOpLessThanEqual(){};

	//!Perform the operation on the stack
	int CSOpLessThanEqual::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one less than or equual to the other (A<=B)
