...
#ifndef CSTAR_OP_Floor_H
#define CSTAR_OP_Floor_H
...
namespace CSTAR
{
	...
	class CSOpFloor: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpFloor();
	...
	static bool blnCSOpFloor_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpFloor>("floor");
    static bool blnCSOpFloor2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpFloor>("CSOpFloor");
}//end namespace
#endif //CSTAR_OP_Floor_H