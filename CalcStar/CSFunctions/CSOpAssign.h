...
#ifndef CSTAR_OP_ASSIGN_H
#define CSTAR_OP_ASSIGN_H
...
namespace CSTAR
{
	...
	class CSOpAssign: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpAssign();
	...
	static bool blnCSOpAssign_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAssign>("=");
	static bool blnCSOpAssign2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAssign>("ASSIGN");
	static bool blnCSOpAssign3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAssign>("CSOpAssign");
}//end namespace
#endif