...
#ifndef CSTAR_OP_AbsoluteValue_H
#define CSTAR_OP_AbsoluteValue_H
...
namespace CSTAR
{
	...
	class CSOpAbsoluteValue: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpAbsoluteValue();
	...
	static bool blnCSOpAbsoluteValue_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAbsoluteValue>("abs");
    static bool blnCSOpAbsoluteValue2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAbsoluteValue>("CSOpAbsoluteValue");
}//end namespace
#endif //CSTAR_OP_AbsoluteValue_H