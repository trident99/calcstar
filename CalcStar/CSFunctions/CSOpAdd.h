...
#ifndef CSTAR_OP_ADD_H
#define CSTAR_OP_ADD_H
...
namespace CSTAR
{
	...
	static bool blnCSOpAdd_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAdd>("+");
	static bool blnCSOpAdd2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAdd>("ADD");
    static bool blnCSOpAdd3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpAdd>("CSOpAdd");
}//end namespace
#endif //CSTAR_OP_ADD_H