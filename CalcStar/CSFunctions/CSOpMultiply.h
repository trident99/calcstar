...
#ifndef CSTAR_OP_Multiply_H
#define CSTAR_OP_Multiply_H
...
namespace CSTAR
{
	...
	class CSOpMultiply: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpMultiply();
	...
	static bool blnCSOpMultiply_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpMultiply>("*");
	static bool blnCSOpMultiply2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpMultiply>("MULT");
	static bool blnCSOpMultiply3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpMultiply>("CSOpMultiply");
}//end namespace
#endif