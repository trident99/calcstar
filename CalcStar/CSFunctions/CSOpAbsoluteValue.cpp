...
#include ".\CSOpAbsoluteValue.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpAbsoluteValue::CSOpAbsoluteValue(): CSOpBase()
	{
		m_intNumInputs = 1;
	};
	//!Default Destructor
	CSOpAbsoluteValue::~CSOpAbsoluteValue(){};

	//!Perform the operation on the stack
	int CSOpAbsoluteValue::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: abs(input)
