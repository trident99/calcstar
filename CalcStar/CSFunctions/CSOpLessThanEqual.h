...
#ifndef CSTAR_OP_LessThanEqual_H
#define CSTAR_OP_LessThanEqual_H
...
namespace CSTAR
{
	...
	class CSOpLessThanEqual: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpLessThanEqual();
	...
	static bool blnCSOpLessThanEqual_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThanEqual>("<=");
	static bool blnCSOpLessThanEqual2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThanEqual>("LTE");
	static bool blnCSOpLessThanEqual3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpLessThanEqual>("CSOpLessThanEqual");
}//end namespace
#endif