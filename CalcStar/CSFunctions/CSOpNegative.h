...
#ifndef CSTAR_OP_Negative_H
#define CSTAR_OP_Negative_H
...
namespace CSTAR
{
	...
	class CSOpNegative: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpNegative();
	...
	static bool blnCSOpNegative_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpNegative>("-");
	static bool blnCSOpNegative2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpNegative>("NEG");
	static bool blnCSOpNegative3_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpNegative>("CSOpNegative");
}//end namespace
#endif