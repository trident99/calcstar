...
#include ".\CSOpLessThan.h"

namespace CSTAR
{

	//!Default Constructor
	CSOpLessThan::CSOpLessThan(): CSOpBase()
	{
		m_intNumInputs = 2;
	};
	//!Default Destructor
	CSOpLessThan::~CSOpLessThan(){};

	//!Perform the operation on the stack
	int CSOpLessThan::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: is one less than the other (A<B)
