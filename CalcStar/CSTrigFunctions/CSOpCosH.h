...
#ifndef CSTAR_OP_CosH_H
#define CSTAR_OP_CosH_H
...
namespace CSTAR
{
	...
	class CSOpCosH: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpCosH();
	...
	static bool blnCSOpCosH_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpCosH>("cosh");
    static bool blnCSOpCosH2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpCosH>("CSOpCosH");
}//end namespace
#endif //CSTAR_OP_CosH_H