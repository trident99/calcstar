...
#ifndef CSTAR_OP_SinH_H
#define CSTAR_OP_SinH_H
...
namespace CSTAR
{
	...
	class CSOpSinH: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpSinH();
	...
	static bool blnCSOpSinH_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSinH>("sinh");
    static bool blnCSOpSinH2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSinH>("CSOpSinH");
}//end namespace
#endif //CSTAR_OP_SinH_H