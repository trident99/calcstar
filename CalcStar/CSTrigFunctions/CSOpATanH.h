...
#ifndef CSTAR_OP_ATanH_H
#define CSTAR_OP_ATanH_H
...
namespace CSTAR
{
	...
	class CSOpATanH: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpATanH();
	...
	static bool blnCSOpATanH_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpATanH>("atanh");
    static bool blnCSOpATanH2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpATanH>("CSOpATanH");
}//end namespace
#endif //CSTAR_OP_ATanH_H