...
#ifndef CSTAR_OP_ASinH_H
#define CSTAR_OP_ASinH_H
...
namespace CSTAR
{
	...
	class CSOpASinH: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpASinH();
	...
	static bool blnCSOpASinH_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpASinH>("asinh");
    static bool blnCSOpASinH2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpASinH>("CSOpASinH");
}//end namespace
#endif //CSTAR_OP_ASinH_H