...
namespace CSTAR
{
	...
	int CSOpATanH::OpEval(std::vector<CSRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful,int intCurrPos)
	{
		//FUNCTION: tan(input)
		...
		try{
			...
			if(blnValid)
			{
				...
				if((fabs(dblInput1-1.0)) >= 0.000001)
				{
