...
#ifndef CSTAR_OP_ACosH_H
#define CSTAR_OP_ACosH_H
...
namespace CSTAR
{
	...
	class CSOpACosH: public CSOpBase
	{
	public:
		//!Default Constructor
		CSOpACosH();
	...
	static bool blnCSOpACosH_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpACosH>("acosh");
    static bool blnCSOpACosH2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpACosH>("CSOpACosH");
}//end namespace
#endif //CSTAR_OP_ACosH_H