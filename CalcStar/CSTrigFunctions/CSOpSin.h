...
#ifndef CSTAR_OP_Sin_H
#define CSTAR_OP_Sin_H
...
namespace CSTAR
{
	...
	static bool blnCSOpSin_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSin>("sin");
    static bool blnCSOpSin2_Registered = CSTAR::GetOpBaseFactoryPtr()->Register<CSOpSin>("CSOpSin");
}//end namespace
#endif //CSTAR_OP_Sin_H